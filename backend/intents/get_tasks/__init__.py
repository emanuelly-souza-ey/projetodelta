...
INTENT_METADATA = IntentMetadata(
    category="get_tasks",
    name="Obter Tarefas",
    description="Consultar tarefas do Azure DevOps. Exemplos: 'quais são minhas tarefas?', 'tarefas ativas do projeto X', 'tasks atribuídas para João', 'work items em progresso'",
